...
#define USBDeviceSetPriority(level) {\
                                        IPC11CLR        = _IPC11_USBIP_MASK | _IPC11_USBIS_MASK;\
                                        IPC11SET        = _IPC11_USBIP_MASK & ((level) << _IPC11_USBIP_POSITION);\
                                    }
#elif defined(_IPC7_USBIP_MASK)
#define USBDeviceSetPriority(level) {\
                                        IPC7CLR        = _IPC7_USBIP_MASK | _IPC7_USBIS_MASK;\
                                        IPC7SET        = _IPC7_USBIP_MASK & ((level) << _IPC7_USBIP_POSITION);\
                                    }
#else
